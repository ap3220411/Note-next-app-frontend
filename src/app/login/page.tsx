        ...
        <div className="bg-white/80 backdrop-blur-lg rounded-3xl shadow-2xl overflow-hidden border border-white/20">
              ...
              <div>
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-indigo-100">Welcome back to your workspace</p>
                  </div>
                </div>
              </div>
          ...
          <div className="px-8 py-10 md:px-12">
            <div className="mb-8 text-center">
              ...
              <p className="text-gray-600 mt-2">Access your notes and continue where you left off</p>
            </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 rounded-xl border-2 border-gray-200 hover:border-indigo-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200 bg-white/50"
                    required
                  />
                </div>
              </div>
